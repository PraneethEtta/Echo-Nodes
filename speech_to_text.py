...
conn_str = (
    ...
    "SERVER=tcp:physician.database.windows.net,1433;"
    "DATABASE=biov2;"
    "UID=chinmay;"
    "PWD=babu@0603;"
    "Encrypt=yes;"
...
# Get Azure Speech API credentials from .env
speech_key = os.getenv("AZURE_SPEECH_KEY")
service_region = os.getenv("AZURE_REGION")
#audio_file = "C:\\Users\\9901016\\Desktop\\hackathon\\doctor_patient_conversation_women.wav"
#audio_file = "C:\\Users\\9901016\\Desktop\\hackathon\\refac_fastapi\\downloaded.wav"

# Initialize Neo4j connection
graph = Neo4jGraph(url="bolt://localhost:7687", username="neo4j", password="Inf0rmati0n@321")

# Initialize Azure OpenAI Chat Model
llm = AzureChatOpenAI(
# Azure OpenAI API Configuration
api_key = '1oBhzAhuDDBWlJNSZTafeSK1ucZRoGVpS2gUXpAiI4ZE4FxlqtuoJQQJ99ALACYeBjFXJ3w3AAABACOGMwbe',
azure_endpoint = 'https://df-azureopenai.openai.azure.com/',
...
# Run transcription and save output
